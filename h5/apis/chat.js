...
export function agentGroups(data){
	return get({
		url: global.agentUrl + '/agent/agent_groups/?user_id='+data,
		data: ''
	})
}
...
export function websites(data){
	return post({
		url: global.agentUrl + '/agent/websites/',
		data: data
	})
}
...
export function agentModels(data){
	return JsomPost({
		url: global.agentUrl + '/agent/models/',
		data: data
	})
}
// 获取智能体详情
...
export function pictures(data){
	return post({
		url: global.agentUrl + '/agent/pictures/',
		data: data
	})
}
...
export function documents(data){
	return JsomPost({
		url: global.agentUrl + '/agent/documents/',
		data: data
	})
}
...
export function groups_model(data){
	return get({
		url: global.agentUrl + '/agent/groups_model/',
		data: data
	})
}
...
export function groups(data){
	return get({
		url: global.agentUrl + '/agent/groups/',
		data: data
	})
}
...
export function agentChat(data){
	return JsomPost({
		url: global.agentUrl + '/agent/chat/',
		data: data
	})
}
...
export function editAgent(data){
	return JsomPost({
		url: global.agentUrl + '/agent/agent_group_edit/',
		data: data
	})
}
