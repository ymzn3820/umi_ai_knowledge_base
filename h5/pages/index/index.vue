...
<script>
	...
	import addKnow from '../../childCont/company/add_know.vue'
	import addStaff from '../../childCont/company/add_staff.vue'
	import userManage from '../../childCont/company/user_manage.vue'
	import companySet from '../../childCont/company/company_set.vue'
	export default {
		data() {
			return {
				active: 0,
		...
		onShow() {
			...
			if(uni.getStorageSync("companyInfo")) {
				let companyInfo = JSON.parse(uni.getStorageSync("companyInfo"));
				this.companyCode = companyInfo.company_code
