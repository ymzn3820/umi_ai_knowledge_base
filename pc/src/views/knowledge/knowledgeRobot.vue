  ...
  <div id="main">
    ...
    <div class="left">
      ...
      >
        <el-submenu index="1">
          <template slot="title">
            <span style="color: #1f64ff;font-size: 16px;font-weight: 600;">我的数字员工</span>
          </template>
    ...
    <div class="right">
      ...
      <div class="knowledgeChat">
        <div class="right-title">
          ...
          <div>点击AI数字员工开启对话，帮助您工作学习提高效率</div>
        </div>
        <!-- 创建AI智能体 -->
        <div class="createdChat">
          <div class="created-box" @click="$router.push('/index/knowledgeCreatedChat')">
      ...
      <div class="knowledge">
        <div class="knowledge-title">
          <div class="right-title">
            ...
            <div>知识库内容会被AI数字员工应用，并用于回答问题</div>
          </div>
          <div>
            API文档
          </div>
        ...
        <div class="knowledge-content">
          <div class="knowledge-box" @click="$router.push('/index//knowledge'),$store.dispatch('app/changeknowledgeLabel', '图片库')">
            <img
              :src="
                httpUrls.ossUrl +
          ...
          <div class="knowledge-box" @click="$router.push('/index//knowledge'),$store.dispatch('app/changeknowledgeLabel', '文档库')">
            <img
              :src="
                httpUrls.ossUrl +
          ...
          <div class="knowledge-box" @click="$router.push('/index//knowledge'),$store.dispatch('app/changeknowledgeLabel', '网址库')">
            <img
              :src="
                httpUrls.ossUrl +
        ...
        Object.keys(res.data).map(key => {
          Object.keys(res.data[key]).map(child => {
            if(res.data[key][child].agent_id == item.agent_id){
              ...
              this.$router.push('/index//knowledgeChat')
        ...
        Object.keys(res.data).map(key => {
          Object.keys(res.data[key]).map(child => {
            if(res.data[key][child].agent_id == item.agent_id){
              ...
              this.$router.push('/index/knowledgeCreatedChat')
            }
          })
        })
      })
