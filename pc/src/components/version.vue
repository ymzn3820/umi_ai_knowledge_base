<template>
  <div class="version" id="version">
    ...
    <el-steps direction="vertical" :active="100" class="version_mask">
      <el-step v-for="item in versionList" :key="item.title" class="stepsStep" icon="el-icon-circle-plus"
        :title="item.title" :description="item.description">
        <template slot="description">
          <span v-for="v in item.content" :style="v.style">{{ v.title }}<br /></span>
        </template>
      </el-step>
    </el-steps>
  </div>
    ...
    return {
      versionList: [
        ...
        },
        {
          ...
          title: "V1.01 2023/5/26",
          content: [
            { title: "1、修复一些问题", style: '' },
            { title: "2、优化页面样式及适配", style: '' }]
        }, {
          title: "V1.0 2023/5/25",
